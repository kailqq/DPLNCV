...
def discriminator_loss(logits_real, logits_fake):
    ...
    ##############################################################################
    # Replace "pass" statement with your code
    real_posi = torch.ones_like(logits_real) #(N, )
    loss_real = torch.nn.functional.binary_cross_entropy_with_logits(logits_real, real_posi)
    targets_fake = torch.zeros_like(logits_fake)
    loss_fake = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, targets_fake)
